...
Et eksempel på en klassifikasjon er https://www.ssb.no/klass/klassifikasjoner/6/[«Standard for næringsgruppering (SN)» &#x29C9;, window="_blank", role="ext-link"] forvaltet og publisert av Statistisk sentralbyrå (SSB), som vi bruker som et gjennomgående eksempel i spesifikasjonen. Andre eksempler er https://www.helsedirektoratet.no/digitalisering-og-e-helse/helsefaglige-kodeverk/icd[«Den internasjonale klassifikasjon av sykdommer og beslektede helseproblemer (ICD-10 og ICD-11)» &#x29C9;, window="_blank", role="ext-link"] og https://www.helsedirektoratet.no/digitalisering-og-e-helse/helsefaglige-kodeverk/icpc[«Den internasjonale klassifikasjonen for primærhelsetjenesten (ICPC-2)» &#x29C9;, window="_blank", role="ext-link"], forvaltet og publisert av Helsedirektoratet.
...
Spesifikasjonen er en norsk applikasjonsprofil og ikke en direkte oversettelse av https://rdf-vocabulary.ddialliance.org/xkos.html[XKOS &#x29C9;, window="_blank", role="ext-link"]. Engelske navn og tekster som er tatt med i spesifikasjonen er ikke alle nødvendigvis ordrett sitat fra engelske kilder.  Vi kan ha valgt en annen engelsk tekst til å formidle det samme budskapet på, med mindre vi eksplisitt sier at det er et avvik (dvs. også i meningsinnholdet).
...
Spesifikasjonen bruker kravnivåene «obligatorisk», «anbefalt» og «valgfri». Disse er forklart i https://data.norge.no/specification/dcat-ap-no/#Om-kravene[DCAT-AP-NO &#x29C9;, window="_blank", role="ext-link"], og forklaringene gjentas ikke her.
...
|uneskos |\http://purl.org/umu/uneskos# | https://skos.um.es/TR/uneskos/[UNESKOS Vocabulary &#x29C9;, window="_blank", role="ext-link"]
