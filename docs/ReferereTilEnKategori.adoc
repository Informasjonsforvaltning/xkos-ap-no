...
Eksempel: Digdir er klassifisert under kategorien «84.110 Generell offentlig administrasjon» i https://www.ssb.no/klass/klassifikasjoner/6[Næringsgruppering 2007 (SN2007) &#x29C9;, window="_blank", role="ext-link"].
