...
<nil90035> a xkos:ConceptAssociation ;
 xkos:targetConcept <sn2007-90035> ; # en målkategori og ingen kildekategori
  dct:type <https://data.norge.no/vocabulary/classification-item-change-type#item-creation> ; # oppretting
  .
...
<01210vs01410n01420> a xkos:ConceptAssociation ;
  ...
  dct:type <https://data.norge.no/vocabulary/classification-item-change-type#item-breakdown> ; # oppsplitting
  .
----
