...
Det foreslåtte vokabularet for endringstyper er beskrevet i henhold til XKOS-AP-NO (denne spesifikasjonen), og gjort tilgjengelig i maskinprosesserbart format RDF Turtle, på https://raw.githubusercontent.com/Informasjonsforvaltning/xkos-ap-no/develop/examples/eksEndringstyper.ttl[Github &#x29C9;, window="_blank", role="ext-link"].
